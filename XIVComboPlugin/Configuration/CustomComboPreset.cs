...
namespace XIVComboPlugin
{
    ...
    public enum CustomComboPreset : long
    {
        ...
        [CustomComboInfo("Fire/Blizzard 1 Stance Switcher", "Change Fire 1 to Blizzard 1 depending on stance.\nOnly use when you are level 4 or higher", 25, new uint[] { BLM.Fire1 })]
